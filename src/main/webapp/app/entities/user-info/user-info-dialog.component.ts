...
import { QuoteOfTheDay, QuoteOfTheDayService } from '../quote-of-the-day';
...
export class UserInfoDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.quoteOfTheDayService.query()
            .subscribe((res: HttpResponse<QuoteOfTheDay[]>) => { this.quoteofthedays = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackQuoteOfTheDayById(index: number, item: QuoteOfTheDay) {
        return item.id;
    }

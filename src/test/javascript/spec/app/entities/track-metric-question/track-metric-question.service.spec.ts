...
describe('Service Tests', () => {
    ...
    describe('TrackMetricQuestion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TrackMetricQuestionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/track-metric-questions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TrackMetricQuestion', () => {
